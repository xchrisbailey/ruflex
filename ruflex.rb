...
downloaded.each do |l|
  ...
  puts("\e[38;5;#{colors[show_color]}m #{show}".ljust(40) + ">S#{season}E#{episode} \e[0m\e[34m|| \e[38;5;#{colors[show_color]}mdownloaded on \e[33m#{day} #{month} #{year}\e[0m".rjust(35))
